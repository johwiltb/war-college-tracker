# Curriculum source verification

Last reviewed: 2026-08-04.

Curriculum entries contain citations, assignments, and links—not copies of copyrighted texts. A link marked verified means its official catalog or publication page was reachable during review; it does not guarantee permanent availability.

## Verified official or archival links

- MCDP 1, *Warfighting* — U.S. Marine Corps Publications Electronic Library (MCPEL) official publication page.
- MCDP 4, *Logistics* — MCPEL official publication page; the current linked publication identifies a 21 March 2023 revision.
- MCDP 5, *Planning* — MCPEL official publication page, listed as current during review.
...
- Louis P. Masur, *The Civil War: A Concise History* (Oxford University Press, 2011). Use an owned or library copy.
- Edward N. Luttwak, *Strategy: The Logic of War and Peace*, revised edition (Belknap Press, 2001). Use an owned or library copy.
...
- The curriculum evaluates reasoning, objectives, enemy/environment understanding, joint integration, sustainment, risk, intent, adaptation, and honest review—not simulated victory alone.
- Public links and publication status should be reviewed at least annually.
