  ...
  return (
    <div className="page week-page">
      ...
      <header className="week-header">
        ...
        <div><p className="eyebrow">{term.title}</p><h1>{week.title}</h1><p>{week.topic}</p><div className="week-meta"><span>{week.era}</span><span>{week.commandLevel}</span><span><Clock3 size={15} /> {week.coreMinutes} min core</span><span>+ {week.extensionMinutes} min optional extension</span></div></div>
      ...
      <div className="workspace-layout">
        ...
        <aside className="workspace-sidebar">
          ...
          <section className="week-outline-card"><p className="section-number">THIS WEEK</p><a href="#readings">Assigned readings <span>{week.readings.length}</span></a><span>Required tasks <b>{week.exercises.length}</b></span><span>Writing prompts <b>{week.prompts.length}</b></span><span>Core path <b>{week.coreMinutes}m</b></span><span>Optional extension <b>{week.extensionMinutes}m</b></span></section>
        </aside>
      </div>
